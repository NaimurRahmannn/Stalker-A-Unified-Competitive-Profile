# Generated by Django 6.0.4 on 2026-05-09 14:14
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('source', models.CharField(choices=[('codeforces', 'Codeforces')], max_length=50)),
                ('handle_or_slug', models.CharField(max_length=255)),
                ('profile_url', models.URLField(blank=True, max_length=500)),
                ('verification_status', models.CharField(choices=[('unverified', 'Unverified'), ('verified', 'Verified'), ('invalid', 'Invalid')], default='unverified', max_length=20)),
            ...
            options={
                'ordering': ['-updated_at'],
                'constraints': [models.UniqueConstraint(fields=('user', 'source'), name='uniq_user_source_account')],
            },
        ),
    ]
